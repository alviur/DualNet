...
CUDA_VISIBLE_DEVICES=$gpu python main.py $CIFAR_100i --model dualnet_tf --lr $lr --n_runs 3 --n_memories 100 --augmentation --beta $beta --temperature $temp --n_epochs 1 --n_outer 2
